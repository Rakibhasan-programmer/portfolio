  ...
  return (
    <div name='home' className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800'>
        <div className='pt-10 max-w-screen-lg mx-auto flex flex-col justify-center items-center h-full px-4 md:flex-row'>
            <div data-aos="fade-down" data-aos-easing="ease-in-out" data-aos-duration="1500" className='flex flex-col justify-center h-full'>
            ...
            <div data-aos = "fade-up" data-aos-easing="ease-in-out" data-aos-duration="1500">
                <img src={image} alt="Gif" className='md:pl-10 rounded-2xl mx-auto w-2/3 md:w-full'  />
            </div>
        </div>
    </div>
  )
